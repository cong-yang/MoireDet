...
ic15_train_data_dir = '/data/zhenyu/smoke/test_data_png'
...
class IC15Loader(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        try:
            ...
            img = img_png[:, :, :3]
        img_png = cv2.resize(img_png,self.img_size)
        density = img_png[:,:,-1]
        ...
        img_png = torch.from_numpy(img_png).float()
        return img,mask, density, training_mask,img_png
