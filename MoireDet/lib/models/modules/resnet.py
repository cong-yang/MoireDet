...
def resnet6(pretrained=False, progress=True, **kwargs):
    ...
    """
    return _resnet('resnet6', BasicBlock, [2, 2], pretrained, progress,
                   **kwargs)
...
def resnet10(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet10', BasicBlock, [2, 2], pretrained, progress,
                   **kwargs)
